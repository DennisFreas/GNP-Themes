...
return array(
    'myaccount' => array(
        ...
        'myaccount_show_slogan' => array(
            'label' => __( 'Show Globe Style Slogan', 'yit' ),
            'desc'  => __( 'Enable Globe Style Slogan in the header', 'yit' ),
            'type'  => 'onoff',
            'std'   => 'yes',
        ),
        ...
        'myaccount_background_image' => array(
            ...
            'type'  => 'upload',
            'std'   => YIT_URL . '/woocommerce/images/cart-checkout-account-slogan.jpg',
            'deps'  => array(
                'ids'       => '_myaccount_show_slogan',
                'values'    => 'yes'
            )

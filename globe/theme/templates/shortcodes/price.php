...
?>
<div class="price-box one-third<?php echo $last; ?>">
	<div class="price-table <?php echo $centered; ?>">
       <div class="price-table-container">
        ...
        <div class="price">
            ...
            <span class="price" style="color:<?php echo $textcolor; ?>"><?php echo $price1; ?></span>
            <span class="price-decimal" style="color:<?php echo $textcolor; ?>"><sup><?php echo $price2; ?></sup></span>

...
<div id="<?php echo $slider_id ?>"<?php $slider->item_class( $slider_class ) ?> style="<?php echo $width_inline; ?><?php echo $height_inline; ?>" <?php echo ( $autoplay ) ? ( 'data-autoplay="' . $autoplay_speed . '"' ) : ''; ?>>

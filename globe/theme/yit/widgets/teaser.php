        ...
        function form( $instance ) {
            ...
            <p>
                ...
                <select id="<?php echo $this->get_field_id( 'button_style' ); ?>" name="<?php echo $this->get_field_name( 'button_style' ); ?>">
                    <option value="flat" <?php selected( $instance['button_style'], 'flat' ) ?>><?php _e( 'Flat', 'yit' ) ?></option>
                    <option value="ghost" <?php selected( $instance['button_style'], 'ghost' ) ?>><?php _e( 'Ghost', 'yit' ) ?></option>

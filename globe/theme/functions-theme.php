...
function yit_setup_theme() {
    ...
    YIT_Theme_Licence()->register( YIT_GLOBE_INIT, YIT_GLOBE_SECRETKEY, YIT_GLOBE_SLUG );
}
...
if ( function_exists( 'vc_add_shortcode_param' ) ) {
    vc_add_shortcode_param( 'select-icon', 'my_param_settings_field' );
 ...
 */
if( function_exists( 'wsl_render_login_form_login_form' ) ){
...
function yit_wsl_style() {
    ...
    <style type="text/css">
        ...
        #wp-social-login-connect-options a.link_socials:hover, #wp-social-login-connect-options a.link_socials:hover i {
            color: #000 !important;
            border-color: #1f1f1f;
        }
    </style>
...
function yit_prelaunch_dequeue_script_and_style( $args ){

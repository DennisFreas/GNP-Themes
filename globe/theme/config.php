...
if( ! defined( 'YIT_DEFAULT_DUMMY_DATA' ) ) {
    define( 'YIT_DEFAULT_DUMMY_DATA', 'https://www.dropbox.com/s/288rl8alluv1quj/globe.gz?dl=1' );
}
...
if( ! defined( 'YIT_DEFAULT_DUMMY_DATA_IMAGES' ) ) {
    define( 'YIT_DEFAULT_DUMMY_DATA_IMAGES', 'https://www.dropbox.com/s/10962zos17b19sx/globe.zip?dl=1' );
}

/**
 * Licence
 */
define( 'YIT_GLOBE_SLUG', 'globe' );
define( 'YIT_GLOBE_SECRETKEY', 'GKlkZhF4sNeusLMhpAzt' );

$theme      = wp_get_theme();
$theme_name = strtolower( str_replace( ' ', '-', $theme->Name ) );

define( 'YIT_GLOBE_INIT', $theme_name );

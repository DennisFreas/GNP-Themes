...
<div class="cart_totals" id="promo-box">


        <!-- START COUPON BOX WRAPPER -->
...
<div class="cart_page_spacer">
    <div class="cart-collaterals border">
        <div class="cart_totals id="continue-to-checkout" <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
            ...
            <input type="submit" class="checkout-button btn btn-flat" id="go-to-checkout" name="proceed" value="<?php _e( 'Proceed to Checkout', 'yit' ); ?>" />

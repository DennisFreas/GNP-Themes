...
echo '<div class="options_group">';
	...
	<p class="form-field <?php echo $field['id'] ?>_field">
       ...
       <label for="<?php echo $field['id'] ?>_none"><input type="radio" name="<?php echo $field['id'] ?>" id="<?php echo $field['id'] ?>_none" value="default"<?php checked($preset, 'default'); ?> /> default</label><br />
